...
so it's unclear what we gain from this.
...
C99 format strings in C<< <inttypes> >>

The VMS toolchain only added support for C<PRIdN> etc very recently, meaning
that there are live supported installions without this, or formats such as
C<%zu>
